...
app.get("/convert/decimal/:decimal", (req,res) => {
    ...
    let b = Number(d).toString(2) //ini kenapa 2? karena binary merupakan bilangan berbasis 2
    let o = Number(d).toString(8) //oktal
    let h = Number(d).toString(16) //hexadecimal
